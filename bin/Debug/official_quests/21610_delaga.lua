...
if EVENT == 371 then -- Accrýted 4 yapmak için 7k CP
...
if EVENT == 372 then -- Accrýted 3 yapmak için 10k CP
   CP = CheckClanPoint(UID)
   if CP < 360000 then
...
if EVENT == 368 then -- Accrýted 2 yapmak için 15k CP
   CP = CheckClanPoint(UID)
   if CP < 540000 then
...
if EVENT == 373 then -- Accrýted 1 yapmak için 20k CP
   CP = CheckClanPoint(UID)
   if CP < 720000 then
...
if EVENT == 369 then -- Royal 4 yapmak için 30k CP
   CP = CheckClanPoint(UID)
   if CP < 1080000 then
