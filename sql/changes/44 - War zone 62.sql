...
INSERT INTO QUEST_HELPER VALUES ((SELECT TOP 1 nIndex FROM QUEST_HELPER ORDER BY nIndex DESC) + 110343,2,1,0,5,1,1,62,20510,0,0,100,0,0,0,'20510_Victory.lua')